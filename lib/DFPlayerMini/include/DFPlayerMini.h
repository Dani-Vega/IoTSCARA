...
public:
    ...
    bool setup(int txd, int rxd, bool isACK, bool doReset, bool debug);
...
Serial serial;
    ...
    void sendStack();
    void sendStack1(uint8_t command);
    void sendStack2(uint8_t command, uint16_t argument);
    void sendStack3(uint8_t command, uint8_t argumentHigh, uint8_t argumentLow);
